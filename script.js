...
const API_KEY = "AIzaSyDTB4toaWaZjJOZYC3l_OJIjFaWusaDBJQ";
...
// Simulate a typing effect for the bot's responses
...
const generateResponse = async (botMsgDiv) => {
  ...
  try {
    ...
    // Process the response text and display it with a typing effect
...
const handleFormSubmit = (e) => {
  ...
  // Generate the user message HTML and add in the chats container
  const userMsgHTML = `
  ...
  setTimeout(() => {
    // Generate the user message HTML and append it to the chats container in the bot message format after 600ms
...
fileInput.addEventListener("change", () => {
  ...
  reader.onload = (e) => {
    fileInput.value = "";
    const base64srting = e.target.result.split(",")[1];
...
// Set the initial from localStorage
